...
class CategoriesTabBar extends StatefulWidget {
  const CategoriesTabBar({super.key, this.child, this.isSearch=false, this.searchCubit});
  final Widget? child;
  final bool isSearch;
 ...
 SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        BlocProvider.value(
          value: widget.searchCubit ?? SearchCubit(),
                ...
                builder: (context, value, child) {
                 return TabBar(
                   ...
                   onTap: (v) {
                     ...
                     if(widget.isSearch) {
                       context.read<SearchCubit>().selectCategory(item[v].label.tr());
                     }
                   },
                   tabs: [
